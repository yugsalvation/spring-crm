...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="javascript:loadFrame('salesexReminders')">My Reminders</a></li>
	  ...
	  <li><a href="javascript:loadFrame('getReports')">Reports</a></li>
	  	
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="http://localhost:8080/spring-crm/salesexChangePassword"><span class="glyphicon glyphicon-edit"></span> Change Password</a></li>
